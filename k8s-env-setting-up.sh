...
# yum install -y kubelet-1.12.0 kubeadm-1.12.0 kubectl-1.12.2
yum install -y kubelet-${K8S_VERSION:-1.12.2} kubeadm-${K8S_VERSION:-1.12.2} kubectl-${K8S_VERSION:-1.12.2} --disableexcludes=kubernetes
